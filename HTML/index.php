...
<body>
    <header class="header-contenedor disable-select" id="header">
        <nav class="nav">
            ...
            <div class="container-icons">
                ...
                <a href="https://www.facebook.com/profile.php?id=100074361196775" target="_blank"><i
                        class="fab fa-facebook-f icon"></i></a>
                <a href="https://www.youtube.com/channel/UCiyLs3C67dYlHt86otVEwJw" target="_blank"><i
            ...
            <div class="modal_content modal_close disable-select">
                <div class="transparencia">
                    ...
                    <div class="button_container_modal">
                        ...
                        <a href="profile.php?id=<?php echo $_SESSION['id']?>"><button
                                onclick="location.href='profile.html'" class="modal_button">Ver perfil</button></a>
                        <?php else:?>
    ...
    <section class="calculos" id="health">
        <article class="cal">
            <div>
                <h2 class="title_calc">IMC</h2>
                <h3 class="subtittle_calc" id="calcul">Calcula tu índice de masa corporal</h3>
                <label>Peso (kg)</label>
                <input class="input_calc" type="number" id="pesoo" onkeypress="return validarNeg(event)">
                <label id="style-label-cal-esta">Estatura (mt)</label>
                <input class="input_calc" type="number" id="estaturaa">
            </div>
            <div class="container_res">
                <textarea id="res" disabled></textarea>
            </div>
            <button type="button" onclick="imc()" class="but but_cal" id="but">Calcular</button>
        </article>
        <article class="metabo">
            <div>
                <h2 class='title_calc title_meta'>Metabolismo basal</h2>
                <h3 class="subtittle_calc">Calcula tu metabolismo basal</h3>
            </div>
            <div class="container_input_meta">
                <div class="container_input">
                    ...
                    <div>
                        <p class="label">Estatura (cm)</p>
                        <input class="input_calc" onkeypress="return soloNumeros(event)" type="number" id="esta">
                    </div>
                </div>
                <div class="container_input">
                    <div>
                        <p class="label">Peso (kg)</p>
                        <input class="input_calc" type="number" id="pes" required onkeypress="return validarNeg(event)">
                    </div>
                    <div>
                        <p class="label">Edad</p>
                        <input class="input_calc" onkeypress="return soloNumeros(event)" type="number" id="ed">
                    </div>
                    <div class="res_meta">
                        <textarea id="resmeta" disabled></textarea>
                        <button class="but_cal" type="button" onclick="meta()" id="metaBasal">Calcular</button>
                    </div>
                </div>
    ...
    <footer>
        <div class="footer_container">
            <div class="sec aboutus">
                <h2>About Us</h2>
                <p>Somos un grupo de instructores especializados y capacitados en la actividad física. Tenemos como
                    objetivo brindarte las mejores asesorías en el campo del entrenamiento y la alimetación.</p>
                <ul class="sci">
                    <li><a href="https://www.facebook.com/profile.php?id=100074361196775" target="_blank"><i
                                class="fab fa-facebook-f"></i></a></li>
                    <li><a href="https://twitter.com/HardWorkUdB" target="_blank"><i class="fab fa-twitter"></i></a>
                    </li>
                    <li><a href="https://www.youtube.com/channel/UCiyLs3C67dYlHt86otVEwJw" target="_blank"><i
                                class="fab fa-youtube"></i></a></li>
                    <li><a href="https://www.snapchat.com/add/hardworkudb" target="_blank"><i
                                class="fab fa-snapchat-ghost"></i></i></a></li>
                </ul>
            </div>
